...
const Dashboard = () => {
  return (
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 p-6 h-screen bg-gray-300">
      ...
      <Link to="/app/acerca-proyecto"
        ...
        <div className=' text-justify'>
          ...
          <p className='text-lg'>Conoce acerca del proyecto, el motivo y el propósito de la aplicación.</p></div>
      </Link>
      ...
      <Link to="/app/gestion"
        ...
        <div className=' text-justify'>
          <h1
            ...
            Gestionador</h1>
          <p className='text-lg '>Aquí puedes gestionar tus residuos, asegúrate de haber registrado tus transportes y generadores antes dejar de registrar los residuos.</p></div>
      </Link>
      ...
      <Link to="/app/generadores"
        ...
        <div className=' text-justify'>
          <h2
            className="underline opacity-0 transition-opacity duration-300 group-hover:opacity-100 font-bold text-2xl pb-3">
            Generadores</h2>
          <p className='text-lg '>Aquí puedes gestionar tus entidades que generan residuos.</p></div>
      </Link>

      {/* Card Transporte*/}
      <Link to="/app/transporte"
        className="relative p-6 bg-green-700 text-black rounded-lg shadow-lg transition duration-300 flex items-center justify-center 
        group">
        ...
        <div className=' text-justify'>
          <h2
            className="underline opacity-0 transition-opacity duration-300 group-hover:opacity-100 font-bold text-2xl pb-3">
            Transporte</h2>
          <p className='text-lg '>Aquí puedes gestionar tus medios de transporte, en los cuales se transportan los residuos.</p></div>
      </Link>
      ...
      <Link to="/app/guia-reciclaje"
        ...
        <div className=' text-justify'>
          ...
          <p className='text-lg '>Pequeña guía de reciclaje de residuos, para que puedas reciclar tus residuos.</p></div>
      </Link>
      {/* Card Perfil*/}
      <Link to="/app/perfil"
        ...
        <div className=' text-justify'>
          <h2
            className="underline opacity-0 transition-opacity duration-300 group-hover:opacity-100 font-bold text-2xl pb-3">
            Perfil</h2>
          <p className='text-lg '>Aquí puedes gestionar tu perfil personales, actualizar tu correo y contraseña.</p></div>
      </Link>
    </div>
